...
public class Parent extends Person{
	...
	{
		LinkedList<Student> sList = new LinkedList<Student>(this.studentList);
		return sList;
	}
	...
	{
		LinkedList<Teacher> tList = new LinkedList<Teacher>(this.teacherList);
		return tList;
	}
	...
	{
		LinkedList<Administrator> aList = new LinkedList<Administrator>(this.adminList);
		return aList;
	}
	 ...
	 * @param aStudent (Student object to set)
	 ...
	 * @param aTeacher (Teacher object to set)
	 * @return true or false for validation
	 */
	 ...
	 * @param anAdmin (Administrator object to set)
	 * @return true or false for validation
	 */
...
=======
>>>>>>> ba64b7940615f4aaca21bec2a895b76df8fba1f5
